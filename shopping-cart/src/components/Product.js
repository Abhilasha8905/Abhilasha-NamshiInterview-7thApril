                        ...
                        <div className="row">
                            {
                                _products.map((item,index)=>(
                                    <div key={index} className="col-md-2" style={{marginBottom:'10px'}}>
                                        ...
                                        <h5>{item.name}</h5>
                                        <span className="badge badge-primary" style={{cursor:'pointer', color: 'black', backgroundColor: 'white', borderBlock: 'inherit', border: '2px solid black' }} onClick={()=>this.props.AddCart(item)}>Add Cart</span>
                                    </div>
                                ))
                            }
                        </div>
